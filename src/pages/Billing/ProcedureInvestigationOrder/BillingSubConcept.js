    ...
    return (
        <div className={classes.subcontent}>
           ...
           {answers.map((item,key) =>
                ...
                <BillingNewTest answers={item.answers} orderDtl ={props.orderDtl} btnValue={props.btnValue} servicdetailsVal={props.servicdetailsVal} addNewInvestigation={props.addNewInvestigation}/>
